CREATE OR REPLACE PROCEDURE DB_CDI_DEV_DWH.TOOLS_SANDBOX.USP_LOAD_HUB_V2("BD_TARGET" VARCHAR(16777216), "SCHEMA_TARGET" VARCHAR(16777216), "TARGET_NAME" VARCHAR(16777216), "FILENAME" VARCHAR(16777216), "FILEDATE" VARCHAR(16777216), "AUDIT_ID" VARCHAR(16777216))
